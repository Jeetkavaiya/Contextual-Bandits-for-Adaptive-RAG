...
\title{RL-RAG: Contextual Bandits for Adaptive Retrieval Augmented Generation}
...
\noindent\textit{(Adjust this table before submission to match actual contributions.)}

%-----------------------------------------------------------
\section*{Reproducibility}
%-----------------------------------------------------------

Repository: \url{https://github.com/ub-cse546-s26/final-project-team_4}. Commit: \texttt{e981d5a}. To reproduce the head to head: install \texttt{requirements\_ccr.txt}, start Ollama with \texttt{llama3.2:3b} and \texttt{nomic-embed-text}, then run
