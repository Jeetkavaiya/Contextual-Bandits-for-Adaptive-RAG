...
Repository: \url{https://github.com/ub-cse546-s26/final-project-team_4}.  
Project board: \url{https://github.com/orgs/ub-cse546-s26/projects/21/views/1}.  
Main comparison artifacts are stored in \texttt{results/compare\_fair/} and include baseline and RL metrics, per query details, and summary files.
